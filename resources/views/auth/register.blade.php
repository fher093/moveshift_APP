        ...
        <div class="w-full max-w-sm">
            ...
            <div class="flex justify-center mb-12">
                ...
                <div class="flex gap-8 border-b-2 border-gray-200 pb-2">
                    ...
                    <a href="{{ route('login') }}" class="text-lg font-medium text-gray-300 hover:text-gray-400 transition-colors pb-3">
                        Iniciar Sesión
                    </a>
                </div>
                ...
                <div class="text-center pt-6">
                    <h1 class="text-4xl font-bold text-gray-900">¡Registrate!</h1>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        >
                        @if ($errors->has('phone'))
                            <p class="mt-2 text-sm text-red-600 font-medium">{{ $errors->first('phone') }}</p>
                        @endif
                    </div>
                    ...
                    <div>
                        ...
                        @if ($errors->has('password_confirmation'))
                            <p class="mt-2 text-sm text-red-600 font-medium">{{ $errors->first('password_confirmation') }}</p>
                        @endif
                    </div>
                    ...
                    <button 
                        type="submit"
                        class="w-full bg-black text-white font-bold py-4 rounded-lg hover:bg-gray-800 transition-colors duration-200 text-lg mt-6">
                        Registrarse
                    </button>
                </form>
